...
goog.provide('online_lenormand.views.reading_reflection');
...
online_lenormand.views.reading_reflection.hue = online_lenormand.util.util.random_color();
online_lenormand.views.reading_reflection.title = (function online_lenormand$views$reading_reflection$title(){
var styles = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$title,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$color,online_lenormand.util.util.title_font_color(online_lenormand.views.reading_reflection.hue),cljs.core.cst$kw$font_DASH_size,"4vw",cljs.core.cst$kw$font_DASH_family,"Lora",cljs.core.cst$kw$font_DASH_weight,"bolder",cljs.core.cst$kw$margin_DASH_bottom,"3vw"], null)], null);
...
online_lenormand.views.reading_reflection.select_meaning = (function online_lenormand$views$reading_reflection$select_meaning(selected_meaning,new_meaning,is_open){
...
online_lenormand.views.reading_reflection.meanings = (function online_lenormand$views$reading_reflection$meanings(number,is_open,selected_meaning){
...
return (function (){
return online_lenormand.views.reading_reflection.select_meaning(selected_meaning,(1),is_open);
...
return (function (){
return online_lenormand.views.reading_reflection.select_meaning(selected_meaning,(2),is_open);
});})(keyword_number,styles))
...
return (function (){
return online_lenormand.views.reading_reflection.select_meaning(selected_meaning,(3),is_open);
});})(keyword_number,styles))
...
online_lenormand.views.reading_reflection.card = (function online_lenormand$views$reading_reflection$card(number,name,clicked){
...
var styles = new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$container,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$align_DASH_items,cljs.core.cst$kw$width,cljs.core.cst$kw$background,cljs.core.cst$kw$cursor,cljs.core.cst$kw$justify_DASH_content,cljs.core.cst$kw$display,cljs.core.cst$kw$border_DASH_radius,cljs.core.cst$kw$flex_DASH_direction,cljs.core.cst$kw$height,cljs.core.cst$kw$margin],["center","12vw",online_lenormand.util.util.card_color(online_lenormand.views.reading_reflection.hue),"pointer","space-between","flex","1em","column","18vw","1em"]),cljs.core.cst$kw$flip_DASH_container,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$align_DASH_items,cljs.core.cst$kw$width,cljs.core.cst$kw$background,cljs.core.cst$kw$cursor,cljs.core.cst$kw$justify_DASH_content,cljs.core.cst$kw$display,cljs.core.cst$kw$border_DASH_radius,cljs.core.cst$kw$flex_DASH_direction,cljs.core.cst$kw$height,cljs.core.cst$kw$margin],["center","12vw",online_lenormand.util.util.card_color(online_lenormand.views.reading_reflection.hue),"pointer","center","flex","1em","column","18vw","1em"]),cljs.core.cst$kw$number_DASH_container,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$align_DASH_self,"flex-start",cljs.core.cst$kw$color,online_lenormand.util.util.card_font_color(online_lenormand.views.reading_reflection.hue),cljs.core.cst$kw$font_DASH_family,"Lora",cljs.core.cst$kw$font_DASH_size,"1.5vw",cljs.core.cst$kw$margin,"1vw"], null),cljs.core.cst$kw$card_DASH_name_DASH_container,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$color,online_lenormand.util.util.card_font_color(online_lenormand.views.reading_reflection.hue),cljs.core.cst$kw$font_DASH_family,"Lora",cljs.core.cst$kw$font_DASH_size,"1.5vw",cljs.core.cst$kw$margin,"1vw"], null),cljs.core.cst$kw$image,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$width,"9vw",cljs.core.cst$kw$filter,"invert(100%)",cljs.core.cst$kw$opacity,".7"], null),cljs.core.cst$kw$interrogation,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$font_DASH_size,"10vw",cljs.core.cst$kw$font_DASH_family,"Lora",cljs.core.cst$kw$color,online_lenormand.util.util.card_font_color(online_lenormand.views.reading_reflection.hue)], null)], null);
...
online_lenormand.views.reading_reflection.include_element = (function online_lenormand$views$reading_reflection$include_element(coll,element){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(coll,element);
});
online_lenormand.views.reading_reflection.draw_cards = (function online_lenormand$views$reading_reflection$draw_cards(number){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(card_numbers,online_lenormand.views.reading_reflection.remove_element,random_15297);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(drawn_cards,online_lenormand.views.reading_reflection.include_element,random_15297);
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(card_numbers,online_lenormand.views.reading_reflection.remove_element,random_15310);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(drawn_cards,online_lenormand.views.reading_reflection.include_element,random_15310);
...
online_lenormand.views.reading_reflection.cards = (function online_lenormand$views$reading_reflection$cards(){
var drawn_cards = online_lenormand.views.reading_reflection.draw_cards((5));
var styles = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$container,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$height,"20em",cljs.core.cst$kw$display,"flex",cljs.core.cst$kw$flex_DASH_direction,"row",cljs.core.cst$kw$align_DASH_items,"flex-start",cljs.core.cst$kw$justify_DASH_content,"center",cljs.core.cst$kw$opacity,(0)], null)], null);
...
return (function online_lenormand$views$reading_reflection$cards_$_iter__15321(s__15322){
...
cljs.core.chunk_append(b__15324,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [online_lenormand.views.reading_reflection.card,number,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(online_lenormand.data.cards_meanings.cards_meanings,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$en,keyword_number,cljs.core.cst$kw$name], null)),clicked], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15324),online_lenormand$views$reading_reflection$cards_$_iter__15321(cljs.core.chunk_rest(s__15322__$2)));
} else {
...
var keyword_number = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1([cljs.core.str.cljs$core$IFn$_invoke$arity$1(number)].join(''));
var clicked = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [online_lenormand.views.reading_reflection.card,number,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(online_lenormand.data.cards_meanings.cards_meanings,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$en,keyword_number,cljs.core.cst$kw$name], null)),clicked], null),online_lenormand$views$reading_reflection$cards_$_iter__15321(cljs.core.rest(s__15322__$2)));
}
} else {
return null;
}
...
online_lenormand.views.reading_reflection.button = (function online_lenormand$views$reading_reflection$button(){
var styles = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$container,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$color,cljs.core.cst$kw$text_DASH_align,cljs.core.cst$kw$font_DASH_size,cljs.core.cst$kw$margin_DASH_top,cljs.core.cst$kw$background,cljs.core.cst$kw$cursor,cljs.core.cst$kw$padding,cljs.core.cst$kw$border,cljs.core.cst$kw$border_DASH_radius],[online_lenormand.util.util.title_font_color(online_lenormand.views.reading_reflection.hue),"center","1.5vw","2.5vw","transparent","pointer","1vw 2vw",[cljs.core.str.cljs$core$IFn$_invoke$arity$1("1px solid "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(online_lenormand.util.util.title_font_color(online_lenormand.views.reading_reflection.hue))].join(''),"100vw"])], null);
...
online_lenormand.views.reading_reflection.reading_reflection = (function online_lenormand$views$reading_reflection$reading_reflection(){
var styles = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$container,new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$background,online_lenormand.util.util.gradient_background(online_lenormand.views.reading_reflection.hue),cljs.core.cst$kw$height,"100%",cljs.core.cst$kw$width,"100%",cljs.core.cst$kw$display,"flex",cljs.core.cst$kw$flex_DASH_direction,"column",cljs.core.cst$kw$align_DASH_items,"center",cljs.core.cst$kw$justify_DASH_content,"center"], null)], null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,cljs.core.cst$kw$container.cljs$core$IFn$_invoke$arity$1(styles)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [online_lenormand.views.reading_reflection.cards], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [online_lenormand.views.reading_reflection.button], null)], null);
});
