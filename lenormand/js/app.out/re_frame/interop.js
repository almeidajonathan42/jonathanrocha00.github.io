...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__14091 = cljs.core.instance_QMARK_;
var expr__14092 = reactive_val;
if(cljs.core.truth_((pred__14091.cljs$core$IFn$_invoke$arity$2 ? pred__14091.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__14092) : pred__14091.call(null,reagent.ratom.RAtom,expr__14092)))){
return "ra";
} else {
if(cljs.core.truth_((pred__14091.cljs$core$IFn$_invoke$arity$2 ? pred__14091.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__14092) : pred__14091.call(null,reagent.ratom.RCursor,expr__14092)))){
return "rc";
} else {
if(cljs.core.truth_((pred__14091.cljs$core$IFn$_invoke$arity$2 ? pred__14091.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__14092) : pred__14091.call(null,reagent.ratom.Reaction,expr__14092)))){
return "rx";
} else {
if(cljs.core.truth_((pred__14091.cljs$core$IFn$_invoke$arity$2 ? pred__14091.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__14092) : pred__14091.call(null,reagent.ratom.Track,expr__14092)))){
return "tr";
} else {
return "other";
}
