...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7796__auto__,writer__7797__auto__,opt__7798__auto__){
return cljs.core._write(writer__7797__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__13886 = o;
(G__13886[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13887__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__13887 = function (var_args){
var args = null;
...
while (G__13888__i < G__13888__a.length) {G__13888__a[G__13888__i] = arguments[G__13888__i + 0]; ++G__13888__i;}
  args = new cljs.core.IndexedSeq(G__13888__a,0,null);
} 
return G__13887__delegate.call(this,args);};
G__13887.cljs$lang$maxFixedArity = 0;
G__13887.cljs$lang$applyTo = (function (arglist__13889){
var args = cljs.core.seq(arglist__13889);
return G__13887__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__7173__auto__ = !((jsprops == null));
if(and__7173__auto__){
var and__7173__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__7173__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__7173__auto____$1;
}
} else {
...
var G__13895 = jsprops;
(G__13895["defaultValue"] = value);

(G__13895["onChange"] = ((function (G__13895,v,value,on_change){
return (function (p1__13892_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13892_SHARP_);
});})(G__13895,v,value,on_change))
);

(G__13895["ref"] = ((function (G__13895,v,value,on_change){
return (function (p1__13893_SHARP_){
return (this$["cljsInputElement"] = p1__13893_SHARP_);
});})(G__13895,v,value,on_change))
);
...
var vec__13902 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13902,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13902,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13902,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13907 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13907 == null)){
} else {
var key_13908 = temp__4661__auto___13907;
(jsprops["key"] = key_13908);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13910 = (new reagent.impl.template.NativeWrapper());
(G__13910["name"] = c);
...
var G__13912 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13912) : reagent.impl.template.as_element.call(null,G__13912));
} else {
...
var len__8298__auto___13918 = arguments.length;
var i__8299__auto___13919 = (0);
while(true){
if((i__8299__auto___13919 < len__8298__auto___13918)){
args__8305__auto__.push((arguments[i__8299__auto___13919]));

var G__13920 = (i__8299__auto___13919 + (1));
i__8299__auto___13919 = G__13920;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8306__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13916){
var G__13917 = cljs.core.first(seq13916);
var seq13916__$1 = cljs.core.next(seq13916);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13917,seq13916__$1);
});
...
break;
default:
var G__13924 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13924;
continue;
...
var n__8108__auto___13927 = a.length;
var i_13928 = (0);
while(true){
if((i_13928 < n__8108__auto___13927)){
(a[i_13928] = reagent.impl.template.as_element((a[i_13928])));

var G__13929 = (i_13928 + (1));
i_13928 = G__13929;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8108__auto___13930 = a.length;
var i_13931 = (0);
while(true){
if((i_13931 < n__8108__auto___13930)){
var val_13932 = (a[i_13931]);
if((cljs.core.vector_QMARK_(val_13932)) && ((reagent.impl.template.key_from_vec(val_13932) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13931] = reagent.impl.template.as_element(val_13932));

var G__13933 = (i_13931 + (1));
i_13931 = G__13933;
continue;
} else {
}
...
var ctx = ({});
var vec__13937 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13937,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13937,(1),null);
...
var G__13941 = (cljs.core.count(argv) - first_child);
switch (G__13941) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13941){
